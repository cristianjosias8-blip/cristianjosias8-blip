...
Sou estudante de Desenvolvimento de Sistemas e estou construindo minha jornada na área de tecnologia, aprendendo na prática através de projetos e novos desafios.
...
* 🔧 Utilizando Git e GitHub para organizar meus projetos
...
Um projeto desenvolvido durante meus estudos de Desenvolvimento de Sistemas, com foco na criação de um sistema para uma lanchonete.

No projeto estou trabalhando com:

* 🖥️ Desenvolvimento do sistema
* 🗄️ Banco de dados
* 🎨 Interface e organização das telas
* 📊 Estruturação das informações
* 🔧 Git e GitHub para gerenciamento do projeto
...
Meu objetivo é continuar evoluindo na área de tecnologia, desenvolver projetos cada vez melhores e transformar meus conhecimentos em experiências práticas.
